  ...
  return (
    <div className=' bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                ...
                <div className='max-w-80'>
                    ...
                    <div className='flex items-center mt-4'>
                        ...
                        <button className='flex items-center justify-center cursor-pointer bg-black h-9 w-9 aspect-square rounded-r'>
                            {/* Arrow icon */}
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} NexStay. All rights reserved.</p>
                <ul className='flex items-center gap-4'>
                    <li><a href="#">Privacy</a></li>
                    <li><a href="#">Terms</a></li>
                    <li><a target='blank' href="https://github.com/AbiNash1017">GitHub</a></li>
                </ul>
            </div>
        </div>
  )
