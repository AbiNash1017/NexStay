...
const AddRoom = () => {
  ...
  return (
    <form action="">
        <Title align='left' font={`outfit`} title={`Add Room`} subTitle={`Complete your listing with precise details, competitive pricing, and comprehensive amenities to elevate the booking experience for your guests.`}/>
        ...
        <div className='grid grid-cols-2 sm:flex gap-4 my-2 flex-wrap'>
            {Object.keys(images).map((key)=>(
                <label htmlFor={`roomImage${key}`}key={key}>
                    <img src={images[key] ? URL.createObjectURL(images[key]) : assets.uploadArea} alt="uploaded-image" 
